<template>
    <div class="login">
        <div class="logo">
            <a href="/">
                <img width="100px" src="../../../public/images/logo.png" alt="">
            </a>
        </div>
        <div class="main">
            <h4 class="title">
            ...
            <div class="more-sign">
                <div class="work-intro">
                    <div class="title">
                        <h2 class="title-text"><span>社交帐号直接注册</span></h2>
                    </div>
                </div>
                <ul>
                    <li>
                    ...
                    <li><a id="weixin" class="weixin" target="_blank" href="/users/auth/wechat"><i class="el-icon-user-solid"></i></a></li>
                    <li><a id="qq" class="qq" href="/users/auth/qq_connect"><i class="el-icon-phone"></i></a></li>
                    <li>其他</li>
                </ul>
